...
$("#solve-btn").click(function () {
    ...
    let algorithm =
        $("#inputGroupSelect04").children("option:selected").val();
    if (algorithm == "Select Algorithm") {
        $("#alerts").append('<div class="alert alert-danger alert-dismissiblefade show" role="alert">\
        ...
        $("#alerts").append('<div class="alert alert-success alert-dismissiblefade show" role="alert">\
